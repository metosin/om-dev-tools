...
return s.replace((new RegExp((function (){var G__22370 = match;
return goog.string.regExpEscape(G__22370);
})(),"g")),replacement);
} else {
...
while(true){
if(coll__$1){
var G__22371 = sb.append([cljs.core.str(cljs.core.first(coll__$1))].join(''));
var G__22372 = cljs.core.next(coll__$1);
sb = G__22371;
coll__$1 = G__22372;
continue;
} else {
...
var G__22375 = cljs.core.pop(v__$1);
v__$1 = G__22375;
continue;
} else {
return v__$1;
...
var expr__22384 = limit;
if(cljs.core.truth_((function (){var G__22386 = (1);
...
if(cljs.core.truth_((function (){var G__22388 = (2);
...
var G__22393 = s__$1.substring((index + cljs.core.count(m)));
var G__22394 = (limit__$1 - (1));
var G__22395 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(parts,s__$1.substring((0),index));
s__$1 = G__22393;
limit__$1 = G__22394;
parts = G__22395;
continue;
...
var G__22397 = s;
return goog.string.trim(G__22397);
});
/**
...
var G__22399 = s;
return goog.string.trimLeft(G__22399);
});
/**
...
var G__22401 = s;
return goog.string.trimRight(G__22401);
});
/**
...
var G__22404 = s;
return goog.string.isEmptySafe(G__22404);
});
/**
...
var temp__4124__auto___22405 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cmap,ch);
if(cljs.core.truth_(temp__4124__auto___22405)){
var replacement_22406 = temp__4124__auto___22405;
buffer.append([cljs.core.str(replacement_22406)].join(''));
} else {
buffer.append(ch);
}

var G__22407 = (index + (1));
index = G__22407;
continue;
}
break;
